...
// information
        ...
        $item1["sku"] = $this->input->post('payment_number');  // Similar to `item_number` in Classic API
        $item1["description"] = $this->input->post('payment_description');
        $item1["currency"] ="PHP";
        $item1["quantity"] =1;
        $item1["price"] = $this->input->post('paymentamount');
...
// the above types and intent set to sale 'sale'
    ...
    public function getPaymentStatus()
    {
        ...
        if ($result->getState() == 'approved') {
            ...
            $itemid = $trans[0]->getItemList()->getItems()[0]->getSku();
